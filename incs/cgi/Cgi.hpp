...
public:
	...
	void		executeCgi( std::string requestedFilePath, std::vector<char>& body );
...
private:
	...
	void	executeChildProcess( std::string requestedFilePath, std::vector<char>& body );
	...
	void	writeBodyToStdIn( std::vector<char>& bdy );
	int		createFork( void );
