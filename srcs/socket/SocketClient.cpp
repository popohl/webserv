...
//   Updated: 2022/03/29 14:36:12 by pcharton         ###   ########.fr       //
/*                                                                            */
/* ************************************************************************** */
...
SocketClient::SocketClient(int port, int fd, ServerNode * ref): ASocket(port, fd, CLIENT), _response(), _server(ref), _request (NULL)
{
